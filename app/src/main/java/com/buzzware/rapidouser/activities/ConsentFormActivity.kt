...
import com.buzzware.rapidouser.databinding.ActivityConsentFormBinding

class ConsentFormActivity : AppCompatActivity() {

    lateinit var binding : ActivityConsentFormBinding
    ...
    private fun setListener() {
        ...
        binding.agreeTV.setOnClickListener {
            val intent = Intent(this, PharmacyLocationActivity::class.java)
